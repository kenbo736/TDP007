...
class ArithmeticConstraint
  ...
  def new_value(connector)
    ...
    if [b,out].include?(connector) and b.has_value? and out.has_value? and 
...
def celsius2fahrenheit()
  c = Connector.new("c")
  f = Connector.new("f")
  multConst = ConstantConnector.new("mc", (9.0/5.0))
  addConst = ConstantConnector.new("ac", 32)
  t = Connector.new("t")
  Multiplier.new(c, multConst, t)
  Adder.new(t, addConst, f)
  return c, f
